		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo",
									"targetURL": "#Projectproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Projectproject1-display": {
								"semanticObject": "Projectproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Project.project1",
									"url": sap.ui.require.toUrl("Project/project1")
								}
							}
						}
					}
